  ...
  return (
    <>
      <Alert variant="warning">
        Warning: Changing a question that already exists will change that
        question for ALL FORMS! Select "New Question" if you want to your
        changes to apply to a question for only this form.
      </Alert>
      <FormControl
        as="select"
        value={selectedInput}
      ...
      <FormText>
        You can create a new question or select one that already exists.
      </FormText>
    </>
  );
}
